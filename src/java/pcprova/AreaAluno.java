    ...
    public void doGet(HttpServletRequest requisicao, HttpServletResponse resposta){
        ...
        try {
            ...
            if(!sessao.getAttribute("matricula").equals(matricula)){
                ...
                escritor.println("<form action=\"/site/Prova\" method=\"get\">");
                ...
                //escritor.println("<form action=\"/site/AreaAluno?matricula="+matricula+"&gravar=false \" method=\"post\"><input type=\"submit\" value=\"ATUALIZAR MEU CADASTRO...\"></form>");
                
                escritor.println("<div class=\"atualizar\">Hora de entrada; "+sessao.getAttribute("HoraEntrada"));
                escritor.println("<form action=/site/CadastroAluno method=\"get\">"
